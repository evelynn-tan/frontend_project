...
export default function Navbar() {
  ...
  const handleLogout = async () => {
    // Logika untuk logout, misalnya menghapus token dari localStorage
              ...
              if (item.id === "logout") {
                return (
                  <button
                    ...
                    red-500 text-white hover:bg-red-600 transition-all duration-300 cursor-pointer shadow-sm"
                  >
                    {item.label}
                  </button>
                );
